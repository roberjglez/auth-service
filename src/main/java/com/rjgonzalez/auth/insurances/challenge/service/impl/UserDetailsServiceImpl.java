package com.rjgonzalez.auth.insurances.challenge.service.impl;
...
import com.rjgonzalez.auth.insurances.challenge.dto.AppUser;
...
public class UserDetailsServiceImpl implements UserDetailsService {
	...
	public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
		...
		final List<AppUser> users = Arrays.asList(new AppUser(1, "roberto", encoder.encode("12345"), "USER"),
